...
public class WeaponReloadAspect implements Aspect<WeaponState, PlayerWeaponInstance> {
    ...
    private ItemAttachment<Weapon> lastMagazine;
    ...
    private void processActualCompoundPermit(CompoundPermit p, PlayerWeaponInstance instance) {
        ...
        lastMagazine = modContext.getAttachmentAspect().removeAttachment(AttachmentCategory.MAGAZINE, instance);
        ...
        else if (lastMagazine instanceof ItemMagazine && !player.isCreative()) {
            ItemStack attachmentItemStack = ((ItemMagazine) lastMagazine).create(originalAmmo);
    ...
    public void rollbackMagazine(PlayerWeaponInstance weaponInstance) {
        WeaponAttachmentAspect.addAttachment(lastMagazine, weaponInstance);
    }
}
